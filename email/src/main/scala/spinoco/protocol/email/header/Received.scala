...
/**
  ...
  */
case class Received(token: String, at: ZonedDateTime) extends EmailHeaderField {
  def name: String = Received.name
}


object Received  extends HeaderDescription[Received]{

  val name: String = "Received"
