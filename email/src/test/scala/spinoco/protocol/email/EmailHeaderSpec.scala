...
import spinoco.protocol.email.header.codec.EmailHeaderCodec

/**
  * Created by pach on 23/10/17.
  */
object EmailHeaderSpec extends  Properties("EmailAddress") {

  property("decode-email") = protect {
    ...
    val expect = EmailHeader(
      List(
        ...
        , ReturnPath("webinfo@info.alza.cz")
        ...
        , MessageId(tag[MessageId]("59ea4ec3.558bdf0a.1f4fc.c8d9SMTPIN_ADDED_BROKEN@mx.google.com"))
        ...
        , GenericField("Content-Type", "text/html; charset=utf-8")
        , GenericField("Content-Transfer-Encoding", "base64")
      )
    )
